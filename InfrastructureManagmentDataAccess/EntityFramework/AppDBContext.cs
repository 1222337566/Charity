...
using InfrastructureManagmentDataAccess.EntityFramework.EF.Charity.Workspace;
...
namespace InfrastructureManagmentDataAccess.EntityFramework
{
    public class AppDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyConfiguration(new GrantorConfiguration());
            builder.ApplyConfiguration(new ProjectFundingAgreementConfiguration());
            builder.ApplyConfiguration(new ProjectFundingInstallmentConfiguration());
            ...
            builder.ApplyConfiguration(new OrganizationDocumentConfiguration());
            ...
            builder.ApplyConfiguration(new UserWorkspaceLayoutConfiguration());
            builder.ApplyConfiguration(new DynamicWorkflowDefinitionConfiguration());
            builder.ApplyConfiguration(new DynamicWorkflowStepTemplateConfiguration());
    ...
    .HasIndex(x => new { x.UserId, x.CreatedAtUtc });
        ...
        public DbSet<UserWorkspaceLayout> UserWorkspaceLayouts { get; set; } = null!;
        public DbSet<DynamicWorkflowDefinition> DynamicWorkflowDefinitions { get; set; } = null!;
        public DbSet<DynamicWorkflowStepTemplate> DynamicWorkflowStepTemplates { get; set; } = null!;
        ...
        public DbSet<Grantor> Grantors => Set<Grantor>();
        public DbSet<ProjectFundingAgreement> ProjectFundingAgreements => Set<ProjectFundingAgreement>();
        public DbSet<ProjectFundingInstallment> ProjectFundingInstallments => Set<ProjectFundingInstallment>();

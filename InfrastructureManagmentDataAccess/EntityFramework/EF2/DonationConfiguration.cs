...
namespace InfrastructureManagmentDataAccess.EntityFramework.EF
{
    public class DonationConfiguration : IEntityTypeConfiguration<Donation>
    {
        public void Configure(EntityTypeBuilder<Donation> builder)
        {
            ...
            builder.Property(x => x.TargetingScopeCode).IsRequired().HasMaxLength(40).HasDefaultValue("SpecificRequests");
            builder.Property(x => x.GeneralPurposeName).HasMaxLength(200);
            ...
            builder.HasIndex(x => x.AidTypeId);
            builder.HasIndex(x => x.TargetingScopeCode);

...
{
    [Authorize(AuthenticationSchemes = "Bearer")] // تأكد أن الـJWT/الكوكيز مفعّلة للـHubs
    public class KanbanHub : Hub
    {
        ...
        {
            var userId = Context.GetUserId(); // من HubCallerContextExtensions
            ...
            await Clients.Caller.SendAsync("JoinedBoard", new { boardId });
        }
